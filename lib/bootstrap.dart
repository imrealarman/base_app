...
Future<void> bootstrap(Environment env) async {
  ...
  await runZonedGuarded(() async {
    ...
    if (savedLocale != null) {
      ...
      // (see lib/i18n/strings.g.dart), and setLocaleSync's buildSync()
      // path never awaits the deferred library, crashing before runApp()
      // is reached — which shows up as the app being stuck on the native
      // splash screen followed by a crash.
